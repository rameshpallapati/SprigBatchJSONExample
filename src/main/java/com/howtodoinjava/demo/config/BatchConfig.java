...
public class BatchConfig {
    ...
    @Value("classPath:/input/emp.json")
    ...
    @Bean
    public JsonFileItemReader jsonReader() {
    	JsonFileItemReader itemReader = new JsonFileItemReader();
        itemReader.setClassToBound("com.howtodoinjava.demo.model.Employee");
